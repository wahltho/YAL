...
function P.initDataref()
    ...
    P.speedbrakeaxis = globalProperty("laminar/B738/axis/speedbrake_lever")
    P.speedbrakecust = globalProperty("laminar/B738/flt_ctrls/speedbrake")
    P.speedbrakearmdetent = globalProperty("laminar/B738/flt_ctrls/speedbrake_arm")
    P.speedbrakeflightdetent = globalProperty("laminar/B738/flt_ctrls/speedbrake_flight")
    P.speedbrakeraw = globalProperty("laminar/B738/flt_ctrls/speedbrake_raw")
    ...
    P.speedbrakearmedannunc = globalProperty("laminar/B738/annunciator/speedbrake_armed")
    P.speedbrakeextendannunc = globalProperty("laminar/B738/annunciator/speedbrake_extend")
    P.speedbrakeservostatus = globalProperty("laminar/B738/flt_ctrls/speedbrake_servo_status")
    P.speedbrakeservotarget = globalProperty("laminar/B738/flt_ctrls/speedbrake_target")
