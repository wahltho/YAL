...
local settingsDefinition = {
    ...
    [def.CONFIGDEPARTURENAVSETUP] = { dvalue = 0 , type = "number", min = 0, max = 1 },
    ...
    [def.CONFIGIVAOAUTOUNICOM] = { dvalue = 0 , type = "number", min = 0, max = 1 },
    [def.CONFIGTODPAUSEGUARD] = { dvalue = 0 , type = "number", min = 0, max = 1 },
